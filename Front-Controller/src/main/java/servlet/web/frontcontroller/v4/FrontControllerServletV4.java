...
public class FrontControllerServletV4 extends HttpServlet{
	...
	public FrontControllerServletV4() {
		controllerMap.put("/home", new MemberHomeControllerV4());
		controllerMap.put("/register", new MemberSaveControllerV4());
		controllerMap.put("/login", new MemberLoginControllerV4());
		controllerMap.put("/members", new MemberListControllerV4());
		controllerMap.put("/home_logined", new MemberLoginedControllerV4());
		controllerMap.put("/login_fail", new MemberLoginFailedControllerV4());
	}
